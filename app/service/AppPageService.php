...
use app\repository\AppPageRepository;
use app\model\AppPage;
use app\validate\AppPageValidate;
use Exception;

/**
 * 小程序页面服务类
 *
 * @property AppPageRepository $repository
 */
class AppPageService extends BaseService
{
    public function __construct(?AppPageRepository $repository = null)
    {
        parent::__construct($repository ?? new AppPageRepository());
    }
    ...
    public function createPage(array $data)
    {
        try {
            ...
            $this->validateWith(AppPageValidate::class, 'create', $data);
    ...
    public function updatePage($id, array $data)
    {
        try {
            ...
            $this->validateWith(AppPageValidate::class, 'update', $data);
