 ...
 * 应用服务类
 *
 * @property AppRepository $repository
 */
class AppService extends BaseService
{
    public function __construct(AppRepository $repository = null)
    {
    ...
    public function createApp(array $data)
    {
        try {
            ...
            $this->validateWith(AppValidate::class, 'create', $data);
    ...
    public function updateApp($id, array $data)
    {
        try {
            ...
            $this->validateWith(AppValidate::class, 'update', $data);
