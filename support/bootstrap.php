...
use app\service\ViewFactoryAdapter;
...
AbstractPaginator::viewFactoryResolver(function () {
    ...
    if ($viewFactory === null) {
        ...
        $blade = new BladeView($viewPath, $cachePath);
        
        // 注册分页视图命名空间
        $paginationPath = base_path('vendor/illuminate/pagination/resources/views');
        $blade->addNamespace('pagination', $paginationPath);
        
        // 创建视图工厂适配器
        $viewFactory = new ViewFactoryAdapter($blade);
    }
